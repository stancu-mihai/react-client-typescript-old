      ...
      <ul className="fa-ul mb-0">
        ...
        <li>
            <ul>
                ...
                <li>Backend is ASP.NET 5 (webapi template) REST API available <a href="https://js7522lknb.execute-api.us-east-1.amazonaws.com/dev/swagger/index.html">here</a>, and uses AWS Lambda and DynamoDB (locally available via Docker container)</li> 
